...
public class TestCuadrado {
	...
	public static void main(String[] args) {
		...
		double area4, perimetro4;
		Cuadrado c4 = new Cuadrado(6);
		area4 = c4.calcularArea();
		perimetro4 = c4.calcularPerimetro();

		System.out.println("El area es: " + area4);
		System.out.println("El perimetro es: " + perimetro4);

		/*
		 * double area1, perimetro1; double area2, perimetro2; double area3, perimetro3;
		 */

		/*
		 * Cuadrado c1 = new Cuadrado(); Cuadrado c2 = new Cuadrado(); Cuadrado c3 = new
		 * Cuadrado();
		 * 
		 * c1.setLado(4); c2.setLado(5); c3.setLado(3);
		 * 
		 * area1 = c1.calcularArea(); area2 = c2.calcularArea(); area3 =
		 * c3.calcularArea();
		 * 
		 * perimetro1 = c1.calcularPerimetro(); perimetro2 = c2.calcularPerimetro();
